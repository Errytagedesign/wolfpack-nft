  ...
  const NavLinks = [
    {
      explore: [
        ...
        { name: 'Marketplace', icon: images.NfcSaving, url: '/marketplace' },
        {
          name: 'DAO Staking Treasure',
          icon: images.MusciNft,
          url: '/staking',
        },
      ],

      stats: [
        { name: 'Earn APY', icon: images.TopApy, url: '/topapy' },
        { name: 'Earn Fees', icon: images.Trending, url: '/trending' },
      ],
